...
** xref:module-01.adoc#storage_live_migrate[Effectuer un Storage live migration][[]]
...
* xref:module-06-observability.adoc[OpenShift Observability]
** xref:module-06-observability.adoc#admin-observability[Vue admin]
** xref:module-06-observability.adoc#user-observability[Vue utilisateur]
** xref:module-06-observability.adoc#virt-observability[Vue dédiée Virtualization]
