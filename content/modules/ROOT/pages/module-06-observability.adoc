...
Nous allons commencer par créer notre UDN dans ce namespace/project dédié.

. Dans le menu de navigation de gauche, cliquez sur *Networking* -> *UserDefinedNetworks*
+
image::2025_spring/module-09-networking/udn01.png[link=self, window=blank, width=40%]
+
. Cliquez ensuite sur *Create* et *UserDefinedNetwork*
+
image::2025_spring/module-09-networking/udn02.png[link=self, window=blank, width=40%]
+
. Choisissez ensuite votre projet et le CIDR de votre choix.
+
image::2025_spring/module-09-networking/udn03.png[link=self, window=blank, width=70%]
+
. Examinon maintenant notre UDN
+
image::2025_spring/module-09-networking/udn04.png[link=self, window=blank, width=80%]
+
