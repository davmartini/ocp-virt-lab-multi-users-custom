...
Étant simple utilisateur OpenShift, vous ne verez pas simplement le noeud sous jacent hébergent votre VM. OpenShift étant une technologie cloud, l'infrastructure doit être transparente pour un utilisateur final. 
