...
+
image::2025_spring/module-09-networking/ncc01.png[link=self, window=blank, width=75%]
...
+
image::2025_spring/module-09-networking/ncc02.png[link=self, window=blank, width=75%]
+
image::2025_spring/module-09-networking/ncc03.png[link=self, window=blank, width=75%]
