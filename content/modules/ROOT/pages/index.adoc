...
Vous trouverez sur ce link:content/modules/10th_March_Virtualization_HandsOn_Workshop_Tech_Journey_Virtualization.pdf[LIEN], le document présenté en début de session.
