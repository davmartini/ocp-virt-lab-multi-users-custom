...
5. Créer les namespace project-1 to 20 with associated role
...
oc adm policy add-cluster-role-to-user admin user$i -n project-$i
oc adm policy add-cluster-role-to-user admin user$i -n udn-projet-$i
done
----
